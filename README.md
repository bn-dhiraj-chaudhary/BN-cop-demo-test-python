...
Minimal Flask/Python project seeded with intentional findings (hardcoded credentials, SQL
injection, OS command injection) so a Coverity on Polaris (COP) scan and a later Black
Duck Polaris scan of the same code both produce comparable issues/merge keys.
